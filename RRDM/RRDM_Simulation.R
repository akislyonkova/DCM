...
save(responses, file = "simresponses.rda") # saves generated datasets 
load(file='simresponses.rda') # loads the responses file 
simdata_9 <- responses[[9]] # extracts a single dataset  
